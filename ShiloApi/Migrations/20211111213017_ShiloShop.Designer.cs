...
namespace ShiloApi.Migrations
{
    ...
    [Migration("20211111213017_ShiloShop")]
    partial class ShiloShop
    {
            ...
            modelBuilder.Entity("ShiloApi.Prodacts", b =>
                {
                    ...
                    b.Property<string>("orderCustumerAddres")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("orderCustumerAddres");
            ...
            modelBuilder.Entity("ShiloApi.Prodacts", b =>
                {
                    b.HasOne("ShiloApi.Orders", "order")
                        .WithMany("prodact")
                        .HasForeignKey("orderCustumerAddres");
                });
